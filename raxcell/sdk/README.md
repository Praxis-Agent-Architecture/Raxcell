...
## Current 0.1.3 Runtime Contract
...
Raxcell keeps macOS Seatbelt and Windows native runners out of the `0.1.3` npm CLI. They remain future backend work.
...
```bash
pnpm add /path/to/praxis-ai-raxcell-0.1.3.tgz
```
...
`0.1.3` is a Linux-first integration package. The API is intentionally small:
